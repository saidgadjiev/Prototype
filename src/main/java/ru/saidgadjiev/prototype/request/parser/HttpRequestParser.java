package ru.saidgadjiev.prototype.request.parser;

import ru.saidgadjiev.prototype.request.lexer.HttpRequest;
import ru.saidgadjiev.prototype.request.lexer.HttpRequestLexer;
import ru.saidgadjiev.prototype.request.lexer.Token;
    ...
    private void header() {
        if (lookahead.getTokenType() == Token.TokenType.WORD) {
            ...
            do {
                ...
                consume();
            } while (lookahead.getTokenType() != Token.TokenType.COLON && lookahead.getTokenType() != Token.TokenType.EOF);
